...
class ClipboardtoFig:
    ...
    def DrawCurve(self):
        ...
        self.drawax.plot(self.data[0], self.data[1], c=c, alpha=alphavalue, marker='o', label = l)
    ...
    def DrawQuadraticCurve(self):
        ...
        fit_data = np.poly1d(np.polyfit(self.data[0], self.data[1], 1))
        ...
        self.drawax.plot(x, fit_data(x), 'k--', alpha=0.7*alphavalue, label=params)
