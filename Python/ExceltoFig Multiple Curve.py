...
legendinfo = ['-400$\mathit{{\mu}m}$', '-350$\mathit{{\mu}m}$', '-300$\mathit{{\mu}m}$', '-250$\mathit{{\mu}m}$', '-200$\mathit{{\mu}m}$',
              '-150$\mathit{{\mu}m}$', '-100$\mathit{{\mu}m}$', '-50$\mathit{{\mu}m}$',
              '0$\mathit{{\mu}m}$', '50$\mathit{{\mu}m}$', '100$\mathit{{\mu}m}$', '150$\mathit{{\mu}m}$', '200$\mathit{{\mu}m}$',
              '250$\mathit{{\mu}m}$', '300$\mathit{{\mu}m}$', '350$\mathit{{\mu}m}$', '400$\mathit{{\mu}m}$']
...
class ClipboardtoFig:
    ...
    def DrawCurve(self):
        ...
        # self.drawax.legend(legendinfo, loc='best', fontsize=tkfont['FontSize'])
        plt.pause(0.001)
